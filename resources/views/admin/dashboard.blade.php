                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-lg">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-gray-600">Jumlah Siswa Aktif</p>
                                <p class="text-2xl font-bold text-gray-900">{{ $jumlahSiswa }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-lg">
                        <div class="flex items-center">
                             <div class="p-3 rounded-full bg-green-500 bg-opacity-20">
                                <svg class="h-8 w-8 text-green-600"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round">  <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" />  <circle cx="12" cy="7" r="4" /></svg>
                            </div>
                            <div class="ml-4">
