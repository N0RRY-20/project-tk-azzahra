            ...
            <form action="{{ route('admin.absensi.siswa') }}" method="GET">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <button type="submit"
                            class="mt-1 w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                            Tampilkan
                        </button>
                    </div>
                </div>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <span
                                    ...
                                    @if (($status == 'Hadir' || $status == 'Terlambat') && $absensi->waktu_hadir)
                                        ({{ date('H:i', strtotime($absensi->waktu_hadir)) }})
                                    @endif
                                </span>
                            </td>
